...
public class GlobalExceptionHandler {
    ...
    public CommonResult<?> allExceptionHandler(HttpServletRequest request, Throwable ex) {
        ...
        if (ex instanceof UnauthorizedException) {
            return unauthorizedExceptionExceptionHandler(request, (UnauthorizedException) ex);
        }
    ...
    private CommonResult<?> redisConnectionExceptionHandler(HttpServletRequest req,RedisConnectionFailureException ex) {
        ...
        return CommonResult.error(BAD_REQUEST.getCode(), String.format("连接redis失败，请求url -》 %s", req.getRequestURL()));
    }
     ...
     * 处理 Shiro 权限不足的异常
     * <p>
     * 来源是，使用 @RequiresRoles,@RequiresPermissions 注解，AOP 进行权限拦截
     */
    @ExceptionHandler(value = AuthorizationException.class)
    public CommonResult<?> unauthorizedExceptionExceptionHandler(HttpServletRequest req, UnauthorizedException ex) {
